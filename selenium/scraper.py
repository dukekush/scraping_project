...
button_submit = driver.find_element(
    By.XPATH, "//button[@class='ds-button ds-width-full']"
)
button_submit.click()
time.sleep(5)
...
while True:
    ...
    try:
        links = driver.find_elements(
            By.XPATH, "//a[starts-with(@href, 'https://www.otomoto.pl/oferta/')]"
        )
        links_list += [
            element.get_attribute("href") for element in links
        ]  # Collecting links
    except:
        pass
    ...
    try:
        ...
        driver.execute_script(
            "arguments[0].click();", button_next_page
        )  # Clicking button to move to a next page of otomoto.pl
    except:
        pass
    ...
    if (
        limit_pages == True and len(links_list) > 100
    ):  # The condition to stop the infinite loop
        break
...
for link in links_list:
    ...
    try:
        make = driver.find_element(
            By.XPATH, "//span[text()='Marka pojazdu']/following-sibling::div/a"
        )
    ...
    try:
        colour = driver.find_element(
            By.XPATH, "//span[text()='Kolor']/following-sibling::div/a"
        )
    ...
    try:
        driven = driver.find_element(
            By.XPATH, "//span[text()='Przebieg']/following-sibling::div"
        )
    ...
    try:
        modell = driver.find_element(
            By.XPATH, "//span[text()='Model pojazdu']/following-sibling::div/a"
        )
    ...
    try:
        power = driver.find_element(
            By.XPATH, "//span[text()='Moc']/following-sibling::div"
        )
    ...
    try:
        year = driver.find_element(
            By.XPATH, "//span[text()='Rok produkcji']/following-sibling::div"
        )
    ...
    try:
        fuel = driver.find_element(
            By.XPATH, "//span[text()='Rodzaj paliwa']/following-sibling::div/a"
        )
    ...
    try:
        capacity = driver.find_element(
            By.XPATH, "//span[text()='Pojemność skokowa']/following-sibling::div"
        )
    ...
    try:
        transmission = driver.find_element(
            By.XPATH, "//span[text()='Skrzynia biegów']/following-sibling::div/a"
        )
    ...
    try:
        drive = driver.find_element(
            By.XPATH, "//span[text()='Napęd']/following-sibling::div/a"
        )
